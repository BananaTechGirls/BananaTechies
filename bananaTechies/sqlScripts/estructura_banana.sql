...
CREATE TABLE `proyecto` (
  ...
  `fecha de inicio` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `fecha final` timestamp NULL DEFAULT NULL,
...
-- Dump completed on 2017-06-23 15:51:49
